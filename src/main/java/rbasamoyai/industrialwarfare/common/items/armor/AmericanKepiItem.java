...
public class AmericanKepiItem extends DyeableArmorItem {
	...
	public AmericanKepiItem(ArmorMaterial material, EquipmentSlot type, Item.Properties properties) {
	...
	public void initializeClient(Consumer<IItemRenderProperties> consumer) {
		consumer.accept(new IItemRenderProperties() {
			...
			public HumanoidModel<?> getArmorModel(LivingEntity entityLiving, ItemStack itemStack, EquipmentSlot armorSlot, HumanoidModel<?> _default) {
				...
				return new AmericanKepiModel(mc.getEntityModels().bakeLayer(ModModelLayers.AMERICAN_KEPI));
			}
		});
	}
