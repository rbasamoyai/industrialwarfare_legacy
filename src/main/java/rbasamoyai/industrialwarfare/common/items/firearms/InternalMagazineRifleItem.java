...
public class InternalMagazineRifleItem extends InternalMagazineFirearmItem {
	...
	protected void shoot(ItemStack firearm, LivingEntity shooter) {
		getDataHandler(firearm).ifPresent(h -> {
			...
			AnimUtils.syncItemStackAnim(firearm, shooter, this, ANIM_FIRING);
	...
	protected void startCycle(ItemStack firearm, LivingEntity shooter) {
		if (this.needsCycle) super.startCycle(firearm, shooter);
	}
