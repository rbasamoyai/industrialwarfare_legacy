...
public class WaitTimeArgHolder implements IArgHolder {
	...
	public CompoundNBT serializeNBT() {
		...
		tag.putByte(TAG_TIME, this.arg);
		return tag;
	}

	@Override
	public void deserializeNBT(CompoundNBT nbt) {
		this.arg = nbt.getByte(TAG_TIME);
	}

	@Override
	public Optional<ArgSelector<?>> getSelector(TaskScrollContainer container) {
		return Optional.of(new WaitTimeArgSelector(this.arg));
	}
