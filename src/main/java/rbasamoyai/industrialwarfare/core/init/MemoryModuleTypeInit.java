...
public class MemoryModuleTypeInit {
	...
	public static final RegistryObject<MemoryModuleType<Boolean>> CAN_ATTACK = MEMORY_MODULE_TYPES.register("can_attack", () -> new MemoryModuleType<>(Optional.of(Codec.BOOL)));
	...
	public static final RegistryObject<MemoryModuleType<Boolean>> ORDER_INTERRUPTED = MEMORY_MODULE_TYPES.register("order_interrupted", () -> new MemoryModuleType<>(Optional.of(Codec.BOOL)));
