...
public class IWNetwork {
	...
	public void init() {
		...
		CHANNEL.registerMessage(id++, SNPCBaseContainerActivate.class, SNPCBaseContainerActivate::encode, SNPCBaseContainerActivate::decode, SNPCBaseContainerActivate::handle);
	}
